...
<div class="container-fluid">
    ...
    <tr class="border-bottom">
        ...
        <td><span class="badge bg-secondary">{{ $manufacturer->device_types_count }}</span></td>
        <td><span class="badge bg-secondary">{{ $manufacturer->inventory_items_count }}</span></td>
        <td><span class="badge bg-secondary">{{ $manufacturer->platforms_count }}</span></td>
